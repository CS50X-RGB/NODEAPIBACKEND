...
import { deleteData, getAllUser, register, specialUser, updateData, userById } from'../Controllers/user.js';
...
router.route('/userId/:userID').get(userById).put(updateData).delete(deleteData)
